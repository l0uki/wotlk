...
func (dk *DpsDeathknight) uhAfterGargoyleSequence(sim *core.Simulation) {
	if dk.Rotation.UseEmpowerRuneWeapon && dk.EmpowerRuneWeapon.IsReady(sim) {
		...
		if dk.BloodTapAura.IsActive() {
			dk.Main.NewAction(dk.RotationActionUH_CancelBT)
		}
		...
		if dk.Rotation.UseDeathAndDecay || !dk.Talents.ScourgeStrike {
			dk.Main.NewAction(dk.RotationActionUH_ResetToDndMain)
		} else {
			dk.Main.NewAction(dk.RotationActionUH_ResetToSsMain)
		}
	}
}
...
func (dk *DpsDeathknight) RotationActionUH_CancelBT(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
...
func (dk *DpsDeathknight) RotationActionUH_ResetToSsMain(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
	dk.Main.Clear().
...
func (dk *DpsDeathknight) RotationActionUH_ResetToDndMain(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
	dk.Main.Clear().
...
func (dk *DpsDeathknight) RotationActionUH_PS_Custom(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
	if dk.uhGargoyleCheck(sim, target, dk.SpellGCD()+50*time.Millisecond) {
		dk.uhAfterGargoyleSequence(sim)
		return true
	}
...
func (dk *DpsDeathknight) RotationActionUH_IT_Custom(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
	if dk.uhGargoyleCheck(sim, target, dk.SpellGCD()+50*time.Millisecond) {
		dk.uhAfterGargoyleSequence(sim)
		return true
	}
...
func (dk *DpsDeathknight) RotationActionUH_IT_SetSync(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
...
func (dk *DpsDeathknight) RotationActionUH_FF_ClipCheck(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
...
func (dk *DpsDeathknight) RotationActionUH_BP_ClipCheck(sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
...
func (dk *DpsDeathknight) RotationActionUH_DiseaseClipCheck(dot *core.Dot, gracePeriod time.Duration, sim *core.Simulation, target *core.Unit, s *deathknight.Sequence) bool {
